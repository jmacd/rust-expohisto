...
├── lookup.rs        # Shared lookup table infrastructure (generated by build.rs)
├── newrelic.rs      # NewRelic lookup table algorithm
└── dynatrace.rs     # Dynatrace lookup table algorithm
