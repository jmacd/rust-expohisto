...
Three histogram sizes are compared:

- **S** — `Histogram<10>`: 128 bytes, 640 bits of counter storage
- **M** — `Histogram<26>`: 256 bytes, 1664 bits of counter storage
- **L** — `Histogram<58>`: 512 bytes, 3712 bits of counter storage

Results are the **median of 21 independent runs** using the actual
...
|:------------------:|:----:|:--------------:|:--------------:|:--------------:|:--------------:|:--------------:|:--------------:|
|        10×         | S (128B) |   7·B1 0.3%    |   4·B4 2.2%    |   2·U8 8.6%    |  1·U16 17.2%   |  1·U16 17.2%   |  -1·U32 60.0%  |
|                    | M (256B) |   9·B1 0.1%    |   7·B2 0.3%    |   4·U8 2.2%    |   2·U16 8.6%   |   2·U16 8.6%   |  0·U32 33.3%   |
|                    | L (512B) |   10·B1 0.0%   |   9·B2 0.1%    |   7·B4 0.3%    |   2·U16 8.6%   |   2·U16 8.6%   |  1·U32 17.2%   |
|                    |      |                |                |                |                |                |                |
|        10²         | S (128B) |   6·B1 0.5%    |   3·B4 4.3%    |   1·U8 17.2%   |  0·U16 33.3%   |  0·U16 33.3%   |  -2·U32 88.2%  |
|                    | M (256B) |   8·B1 0.1%    |   6·B2 0.5%    |   3·U8 4.3%    |  1·U16 17.2%   |  1·U16 17.2%   |  -1·U32 60.0%  |
|                    | L (512B) |   9·B1 0.1%    |   7·B2 0.3%    |   3·U8 4.3%    |   2·U16 8.6%   |   2·U16 8.6%   |  0·U32 33.3%   |
|                    |      |                |                |                |                |                |                |
|        10³         | S (128B) |   6·B1 0.5%    |   2·B4 8.6%    |   1·U8 17.2%   |  -1·U16 60.0%  |  -1·U16 60.0%  |  -3·U32 99.2%  |
|                    | M (256B) |   7·B1 0.3%    |   6·B2 0.5%    |   2·U8 8.6%    |  0·U16 33.3%   |  0·U16 33.3%   |  -2·U32 88.2%  |
|                    | L (512B) |   8·B1 0.1%    |   7·B2 0.3%    |   5·B4 1.1%    |  1·U16 17.2%   |   2·U16 8.6%   |  0·U32 33.3%   |
|                    |      |                |                |                |                |                |                |
|        10⁴         | S (128B) |   5·B1 1.1%    |   2·B4 8.6%    |   0·U8 33.3%   |  -1·U16 60.0%  |  -1·U16 60.0%  |  -3·U32 99.2%  |
|                    | M (256B) |   7·B1 0.3%    |   5·B2 1.1%    |   2·U8 8.6%    |  0·U16 33.3%   |  0·U16 33.3%   |  -2·U32 88.2%  |
|                    | L (512B) |   8·B1 0.1%    |   7·B2 0.3%    |   2·U8 8.6%    |  1·U16 17.2%   |  1·U16 17.2%   |  -1·U32 60.0%  |
|                    |      |                |                |                |                |                |                |
|        10⁵         | S (128B) |   5·B1 1.1%    |   1·B4 17.2%   |   0·U8 33.3%   |  -2·U16 88.2%  | -4·U32 100.0%  |  -3·U32 99.2%  |
|                    | M (256B) |   6·B1 0.5%    |   5·B2 1.1%    |   1·U8 17.2%   |  -1·U16 60.0%  |  -1·U16 60.0%  |  -2·U32 88.2%  |
|                    | L (512B) |   7·B1 0.3%    |   6·B2 0.5%    |   2·U8 8.6%    |  0·U16 33.3%   |  1·U16 17.2%   |  -1·U32 60.0%  |
|                    |      |                |                |                |                |                |                |
|        10⁶         | S (128B) |   4·B1 2.2%    |   1·B4 17.2%   |   0·U8 33.3%   |  -2·U16 88.2%  |  -2·U16 88.2%  | -4·U32 100.0%  |
|                    | M (256B) |   6·B1 0.5%    |   4·B2 2.2%    |   1·U8 17.2%   |  -1·U16 60.0%  |  -1·U16 60.0%  |  -3·U32 99.2%  |
|                    | L (512B) |   7·B1 0.3%    |   5·B2 1.1%    |   4·B4 2.2%    |  0·U16 33.3%   |  1·U16 17.2%   |  -2·U32 88.2%  |
...
- At moderate counts (n ≈ 1K–10K), the L (512B) configuration
  matches or exceeds the 160-bucket default's resolution.
...
| Size | Bytes | Best for |
|------|-------|----------|
| S (`Histogram<10>`)  | 128  | Embedded, high-cardinality, `no_std` |
| M (`Histogram<26>`)  | 256  | General-purpose OTel metrics |
| L (`Histogram<58>`)  | 512  | High-resolution, long intervals |

Choose the smallest size whose error% is acceptable for your
contrast and count. For most OTel workloads (contrast 10³–10⁵,
n ≈ 1K–100K), the M (256B) configuration provides 2–4% error.
